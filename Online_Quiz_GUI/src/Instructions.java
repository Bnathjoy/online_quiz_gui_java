...
public class Instructions extends JFrame {
	...
	public Instructions() {
		...
		JLabel lblNewLabel_1 = new JLabel("American International University-Bangladesh\n\n\n\n");
		lblNewLabel_1.setForeground(new Color(100, 0, 0));
		lblNewLabel_1.setBackground(new Color(0, 0, 255));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel_1.setBounds(224, 110, 707, 43);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("FACULTY OF SCIENCE & TECHNOLOGY");
		lblNewLabel_2.setForeground(new Color(0, 0, 0));
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel_2.setBounds(374, 152, 383, 32);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Computer Science & Engineering");
		lblNewLabel_3.setForeground(new Color(0, 0, 0));
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel_3.setBounds(384, 181, 345, 32);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("D:\\AIUB\\CODING\\JAVA\\LEARN\\Online_Quiz_GUI\\Pictures\\rsz_171ixd6yesnl.png"));
