...
public class login extends JFrame {
	...
	public login() {
		...
		leftGif.setIcon(new ImageIcon("D:\\AIUB\\CODING\\JAVA\\LEARN\\Online_Quiz_GUI\\Pictures\\thoughtworks-gif_dribbble.gif"));
		...
		userPIC.setIcon(new ImageIcon("D:\\AIUB\\CODING\\JAVA\\LEARN\\Online_Quiz_GUI\\Pictures\\rsz_png-transparent-login-computer-icons-password-login-black-symbol-subscription-business-model-thumbnail-removebg-preview.png"));
		userPIC.setBounds(528, 175, 31, 31);
		contentPane.add(userPIC);
		
		JLabel passPIC = new JLabel("");
		passPIC.setIcon(new ImageIcon("D:\\AIUB\\CODING\\JAVA\\LEARN\\Online_Quiz_GUI\\Pictures\\rsz_268-2683321_change-password-svg-png-icon-free-download-password-removebg-preview.png"));
		passPIC.setBounds(528, 239, 31, 31);
		contentPane.add(passPIC);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("D:\\AIUB\\CODING\\JAVA\\LEARN\\Online_Quiz_GUI\\Pictures\\rsz_1aiub_whole_logo.png"));
